    ...
    return (
      <View style={styles.container}>
        <View style={styles.direction}>
          ...
          <Switch value={this.state.vertical} onValueChange={value => this.setState({ vertical: value })} />
          <Text style={{ marginRight: 6, marginLeft: 24 }}>Can drag:</Text>
          <Switch value={this.state.dragEnabled} onValueChange={value => this.setState({ dragEnabled: value })} />
        </View>
