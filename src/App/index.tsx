...
//     super(props);
//     this.state = {
//       appId: `c6d92f0ada97406ea72ef4573ea6361a`,
//       token:
//         '006c6d92f0ada97406ea72ef4573ea6361aIACA8M+FXt0ieB+8f5mYrqxnr63b8nb1dMc+XTMCLLnj9Qx+f9gAAAAAEABoKgnHyeEvYAEAAQDI4S9g',
//       channelName: 'test',
//       openMicrophone: true,
...
//   render() {
//     const { channelName, joinSucceed, openMicrophone, enableSpeakerphone } = this.state;
//     return (
...
//           <Button onPress={this._switchMicrophone} title={`Microphone ${openMicrophone ? 'on' : 'off'}`} />
//           <Button onPress={this._switchSpeakerphone} title={enableSpeakerphone ? 'Speakerphone' : 'Earpiece'} />
//         </View>
//       </View>
//     );
//   }
...
const App = () => {
  ...
  const rtcProps = {
    ...
    channel: 'test',
    token:
      '006c6d92f0ada97406ea72ef4573ea6361aIAD3zxldjrtk4628QuP6e3beU/Q6puzDLpZj1vU4gKXQkwx+f9gAAAAAEACroQtqN6M0YAEAAQA2ozRg',
  };
  const callbacks = {
